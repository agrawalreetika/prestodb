        ...
        implements ErrorCodeSupplier
{
    ...
    // GPU-specific error codes (retriable for GPU -> CPU fallback)
    GPU_OOM_FAULT(0x0002_001A, INSUFFICIENT_RESOURCES, true),
    GPU_DEVICE_LOST(0x0002_001B, INTERNAL_ERROR, true),
    GPU_KERNEL_TIMEOUT(0x0002_001C, INTERNAL_ERROR, true),
    GPU_DRIVER_ERROR(0x0002_001D, INTERNAL_ERROR, true),
    /**/;
