        ...
        implements Provider<Procedure>
{
    private static final MethodHandle CACHE_DATA_INVALIDATION = methodHandle(
            IcebergManifestFileCacheInvalidationProcedure.class,
            "icebergManifestFileCacheInvalidation");

    private final ManifestFileCache manifestFileCache;

    @Inject
    public IcebergManifestFileCacheInvalidationProcedure(ManifestFileCache manifestFileCache)
    {
    ...
    public Procedure get()
    {
        return new Procedure(
                "system",
                "invalidate_iceberg_manifest_file_cache",
                ImmutableList.of(),
    ...
    public void icebergManifestFileCacheInvalidation()
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(getClass().getClassLoader())) {
            manifestFileCache.invalidateManifestFileCache();
        }
    }
}
