        ...
        implements Provider<Procedure>
{
    private static final MethodHandle CACHE_DATA_INVALIDATION = methodHandle(
            IcebergStatisticsFileCacheInvalidationProcedure.class,
            "icebergStatisticsFileCacheInvalidation");

    private final StatisticsFileCache statisticsFileCache;

    @Inject
    public IcebergStatisticsFileCacheInvalidationProcedure(StatisticsFileCache statisticsFileCache)
    {
    ...
    public Procedure get()
    {
        return new Procedure(
                "system",
                "invalidate_iceberg_statistics_file_cache",
                ImmutableList.of(),
    ...
    public void icebergStatisticsFileCacheInvalidation()
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(getClass().getClassLoader())) {
            statisticsFileCache.invalidateStatisticsFileCache();
        }
    }
}
