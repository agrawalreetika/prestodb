        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testSnapshotSequenceNumberPredicatePushdown()
    {
        ...
        try {
            ...
            assertQuery("SELECT COUNT(*) FROM " + tableName + " WHERE \"$snapshot_sequence_number\" = " + currentSnapshotSequenceNumber, "VALUES 3");
