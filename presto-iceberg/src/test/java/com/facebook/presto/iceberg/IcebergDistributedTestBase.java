        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testStatisticsFileCacheProcedure()
    {
        ...
        //test invalidate_iceberg_statistics_file_cache procedure
        assertQuerySucceeds(format("CALL %s.system.invalidate_iceberg_statistics_file_cache()", getSession().getCatalog().get()));
